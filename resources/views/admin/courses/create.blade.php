    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <ul class="gctu-breadcrumbs">
                ...
                <li class="bc-sep"><i class="fas fa-chevron-right"></i></li>
                <li class="bc-active">Add New</li>
            </ul>
            <h1 style="font-size:1.55rem; font-weight:800; color:#0f172a; margin:0 0 4px;">Add New Course</h1>
            <p style="font-size:0.82rem; color:#64748b; margin:0;">Create a new course module and assign it to a program.</p>
        </div>
        <div>
            ...
            <div class="dash-panel">
                <div class="panel-header-pro" style="background:#f8fafc; border-bottom:1px solid #e2e8f0; padding:1.25rem 1.5rem;">
                    <h5 style="margin:0; font-size:1.05rem; font-weight:800; color:#0f172a;">
                        <i class="fas fa-book me-2" style="color:#10b981;"></i>Course Creation Form
                    </h5>
                </div>
                    ...
                    <form action="{{ route('admin.courses.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title" value="{{ old('title') }}" 
                                   placeholder="e.g. Introduction to Software Engineering" required
                                   style="width:100%; height:44px; padding:0 14px; border:1px solid #cbd5e1; border-radius:10px; font-size:0.85rem; color:#0f172a; transition:border-color 0.2s; outline:none;"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" id="credits" name="credits" value="{{ old('credits', 3) }}" min="1" max="6" required
                                       style="width:100%; height:44px; padding:0 14px; border:1px solid #cbd5e1; border-radius:10px; font-size:0.85rem; color:#0f172a; outline:none;"
                                       onfocus="this.style.borderColor='#6366f1'" onblur="this.style.borderColor='#cbd5e1'">
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select id="level" name="level" required
                                    ...
                                    @foreach([100, 200, 300, 400] as $lvl)
                                        <option value="{{ $lvl }}" {{ old('level') == $lvl ? 'selected' : '' }}>Level {{ $lvl }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-4">
