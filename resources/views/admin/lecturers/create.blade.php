...
<div style="max-width:1440px; margin:0 auto; padding:0 0.5rem 2rem;">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            ...
            <h1 style="font-size:1.55rem; font-weight:800; color:#0f172a; margin:0 0 4px;">Register Lecturer</h1>
            <p style="font-size:0.82rem; color:#64748b; margin:0;">Pre-register a lecturer to allow them to activate their account.</p>
        </div>
        <div>
            ...
            <div class="dash-panel">
                <div class="panel-header-pro" style="background:#f8fafc; border-bottom:1px solid #e2e8f0; padding:1.25rem 1.5rem;">
                    <h5 style="margin:0; font-size:1.05rem; font-weight:800; color:#0f172a;">
                        <i class="fas fa-user-plus me-2" style="color:#4f46e5;"></i>Lecturer Registration
                    </h5>
                </div>
                    ...
                    <form action="{{ route('admin.lecturers.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email') }}" 
                                       placeholder="user@gctu.edu.gh" required
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" id="staff_id" name="staff_id" value="{{ old('staff_id') }}" 
                                       placeholder="GCTU-LEC-0000" required
                                       style="width:100%; height:44px; padding:0 14px; border:1px solid #cbd5e1; border-radius:10px; font-size:0.85rem; color:#0f172a; outline:none;"
                                       onfocus="this.style.borderColor='#6366f1'" onblur="this.style.borderColor='#cbd5e1'">
                            </div>
                            <div class="col-md-6 mb-4">
                        ...
                        <div class="d-flex justify-content-end gap-3 mt-5 pt-4 border-top" style="border-color:#e2e8f0;">
                            ...
                            <button type="submit" 
                                ...
                                <i class="fas fa-save"></i> Register Lecturer
                            </button>
                        </div>
                    </form>
                </div>
